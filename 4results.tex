...
\begin{figure}[]
    ...
    \begin{subfigure}{\textwidth}
        ...
        \begin{subfigure}{0.24\textwidth}
            \centering
            \begin{tikzpicture}
                \draw (0, 0) node[inner sep=0] {\includegraphics[width=\textwidth]{images/04-experiment02/human/marble/gatys_im_label.jpg}};
        ...
        \begin{subfigure}{0.24\textwidth}
            \centering
            \begin{tikzpicture}
                \draw (0, 0) node[inner sep=0] {\includegraphics[width=\textwidth]{images/04-experiment02/human/marble/gatys_proj_label.jpg}};
                \fill[black] (-1.05, 1.5) rectangle ++(2.6, 0.6);
                \node [anchor=center] at (0.25, 1.8) {{\color{white} Ours (Gatys)}};
            \end{tikzpicture}
        ...
        \begin{subfigure}{0.24\textwidth}
            \centering
            \begin{tikzpicture}
                \draw (0, 0) node[inner sep=0] {\includegraphics[width=\textwidth]{images/04-experiment02/human/marble/improved_im_label.jpg}};
        ...
        \begin{subfigure}{0.24\textwidth}
            \centering
            \begin{tikzpicture}
                \draw (0, 0) node[inner sep=0] {\includegraphics[width=\textwidth]{images/04-experiment02/human/marble/improved_proj_label.jpg}};
                \fill[black] (-1.55, 1.5) rectangle ++(3.1, 0.6);
                \node [anchor=center] at (0.0, 1.8) {{\color{white} \small{Ours (Improved)}}};
            \end{tikzpicture}
        ...
        \begin{subfigure}{0.24\textwidth}
            \centering
            \begin{tikzpicture}
                \draw (0, 0) node[inner sep=0] {\includegraphics[width=\textwidth]{images/04-experiment02/human/marble/pixel_im_label.jpg}};
                \fill[black] (-1.05, 1.5) rectangle ++(2.6, 0.6);
        ...
        \begin{subfigure}{0.24\textwidth}
            \centering
            \begin{tikzpicture}
                \draw (0, 0) node[inner sep=0] {\includegraphics[width=\textwidth]{images/04-experiment02/human/marble/pixel_proj_label.jpg}};
                \fill[black] (-1.05, 1.5) rectangle ++(2.6, 0.6);
                \node [anchor=center] at (0.25, 1.8) {{\color{white} Reference}};
            \end{tikzpicture}
    ...
    \begin{subfigure}{0.6\textwidth}
        ...
        \begin{subfigure}{0.48\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \fill[black] (-0.7, 1.95) rectangle ++(2.6, 0.6);
                \node [anchor=center] at (0.6, 2.25) {{\color{white} Reference}};
                \draw[line width=0.5mm, green] (-0.9, -1.0) rectangle ++(1.167, 1.25);
                \draw[line width=0.5mm, orange] (-1.275, -2.55) rectangle ++(2.0, 1.25);
                \draw[line width=0.5mm, red] (-1.895, -2.55) rectangle ++(0.57, 1.25);
            \end{tikzpicture}
