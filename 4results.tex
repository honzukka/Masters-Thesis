...
\begin{figure}[]
    ...
    \begin{subfigure}{0.6\textwidth}
        ...
        \begin{subfigure}{0.48\textwidth}
            ...
            \begin{tikzpicture}
                \draw (0, 0) node[inner sep=0] {\includegraphics[width=\textwidth]{images/04-experiment02/human/marble/gatys_proj.jpg}};
                \fill[black] (-0.7, 1.95) rectangle ++(2.6, 0.6);
                \node [anchor=center] at (0.6, 2.25) {{\color{white} Ours (Gatys)}};
                \draw[line width=0.5mm, green] (-0.9, -1.0) rectangle ++(1.167, 1.25);
                \draw[line width=0.5mm, orange] (-1.275, -2.55) rectangle ++(2.0, 1.25);
                \draw[line width=0.5mm, red] (-1.895, -2.55) rectangle ++(0.57, 1.25);
            \end{tikzpicture}
        ...
        \begin{subfigure}{0.48\textwidth}
            ...
            \begin{subfigure}{0.32\textwidth}
                ...
                \begin{tikzpicture}
                    ...
                    \draw[line width=0.5mm, red] (-0.62, -1.25) rectangle ++(1.24, 2.5);
                \end{tikzpicture}
            ...
            \begin{subfigure}{0.6\textwidth}
                ...
                \begin{tikzpicture}
                    ...
                    \draw[line width=0.5mm, green] (-1.167, -1.25) rectangle ++(2.334, 2.5);
                \end{tikzpicture}
            ...
            \begin{subfigure}{\textwidth}
                ...
                \begin{tikzpicture}
                    ...
                    \draw[line width=0.5mm, orange] (-1.95, -1.2) rectangle ++(3.9, 2.4);
                \end{tikzpicture}
    ...
    \begin{subfigure}{0.6\textwidth}
        ...
        \begin{subfigure}{0.48\textwidth}
            ...
            \begin{tikzpicture}
                \draw (0, 0) node[inner sep=0] {\includegraphics[width=\textwidth]{images/04-experiment02/human/marble/improved_proj.jpg}};
                \fill[black] (-1.3, 1.95) rectangle ++(3.2, 0.6);
                \node [anchor=center] at (0.3, 2.25) {{\color{white} Ours (Improved)}};
                \draw[line width=0.5mm, green] (-0.9, -1.0) rectangle ++(1.167, 1.25);
                \draw[line width=0.5mm, orange] (-1.275, -2.55) rectangle ++(2.0, 1.25);
                \draw[line width=0.5mm, red] (-1.895, -2.55) rectangle ++(0.57, 1.25);
            \end{tikzpicture}
    ...
    \begin{subfigure}{0.6\textwidth}
        ...
        \begin{subfigure}{0.48\textwidth}
            ...
            \begin{tikzpicture}
                \draw (0, 0) node[inner sep=0] {\includegraphics[width=\textwidth]{images/04-experiment02/human/marble/pixel_proj.jpg}};
                \fill[black] (-0.7, 1.95) rectangle ++(2.6, 0.6);
                \node [anchor=center] at (0.6, 2.25) {{\color{white} Baseline}};
                \draw[line width=0.5mm, green] (-0.9, -1.0) rectangle ++(1.167, 1.25);
                \draw[line width=0.5mm, orange] (-1.275, -2.55) rectangle ++(2.0, 1.25);
                \draw[line width=0.5mm, red] (-1.895, -2.55) rectangle ++(0.57, 1.25);
            \end{tikzpicture}
        ...
        %\label{fig:ex02-human-marble-detail-crops}
    \end{subfigure}
    \caption{A magnified detail of results from fig.~\ref{fig:ex02-human-marble} showing the desired appearance \(\bm{y}\) in the first column and the actual appearance \(r(\bm{p})\) in the other columns for each method. Note how both micro-texture (color) is best reproduced by our method (top and middle). Macro-texture (marble structure) is best reproduced by our method with the improved texture model (middle) and the pixel-based baseline (bottom). Texture source: \citet{Pixar128}}
