...
{\color{red} TODO: Jaakko finds it strange that the optimizer pushes pixel values all the way to max (mostly in the staircase scene) commenting on this will help!}
...
{\color{red} TODO: indicate the description below in a zoomed-in image?}
