...
% if boxes are overfull, they are given another chance with this
% amount of stretch on top of badness
% (doesn't influence good paragraphs and gives a warning anyway!)
