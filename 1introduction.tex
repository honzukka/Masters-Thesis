    ...
    \begin{subfigure}{\textwidth}
        ...
        \begin{subfigure}{0.3\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \fill[black] (0.5, -1.45) rectangle ++(1.4, 0.5);
                \node [anchor=center] at (1.2, -1.2) {{\color{white} Ours}};
            \end{tikzpicture}
        ...
        \begin{subfigure}{0.3\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \fill[black] (-0.3, -1.45) rectangle ++(2.2, 0.5);
                \node [anchor=center] at (0.8, -1.2) {{\color{white} Reference}};
            \end{tikzpicture}
        ...
        \begin{subfigure}{0.3\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \draw[line width=0.5mm, white] (-0.75, 0.5) ellipse (0.4cm and 0.55cm);
                \draw[line width=0.5mm, magenta] (0.25, 1.05) ellipse (0.7cm and 0.45cm);
            \end{tikzpicture}
        ...
        \begin{subfigure}{0.3\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \draw[line width=0.5mm, magenta] (0.25, 1.05) ellipse (0.7cm and 0.45cm);
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/01-results_teaser-stats_proj_highlighted.jpg}
            \caption{\(r(\bm{p})\)}
        ...
        \begin{subfigure}{0.3\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \draw[line width=0.5mm, magenta] (0.25, 1.05) ellipse (0.7cm and 0.45cm);
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/01-results_teaser-pixels_proj_highlighted.jpg}
            \caption{\(r(\bm{p})\)}
