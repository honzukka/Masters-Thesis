    ...
    \begin{subfigure}{\textwidth}
        ...
        \begin{subfigure}{0.32\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \fill[black] (0.65, -1.55) rectangle ++(1.4, 0.5);
                \node [anchor=center] at (1.35, -1.3) {{\color{white} Ours}};
            \end{tikzpicture}
            \caption{Compensated projection image \(\bm{p}\)}
        ...
        \begin{subfigure}{0.32\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \fill[black] (-0.15, -1.55) rectangle ++(2.2, 0.5);
                \node [anchor=center] at (0.95, -1.3) {{\color{white} Baseline}};
            \end{tikzpicture}
            \caption{Compensated projection image \(\bm{p}\)}
        ...
        \begin{subfigure}{0.32\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \fill[black] (0.65, -1.55) rectangle ++(1.4, 0.5);
                \node [anchor=center] at (1.35, -1.3) {{\color{white} Ours}};
                \draw[line width=0.8mm, white] (-0.75, 0.5) ellipse (0.4cm and 0.55cm);
                \draw[line width=0.8mm, magenta] (0.25, 1.05) ellipse (0.7cm and 0.45cm);
            \end{tikzpicture}
            \caption{Final appearance \(r(\bm{p})\)}
