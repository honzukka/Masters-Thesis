...
\begin{itemize}
    ...
    \item Our recipe needs a texture model (referred to as function \(f\) in section \ref{section:intro-key_idea}) which would determine the extent to which two different image are realizations of the same texture. We survey the field of \textit{texture synthesis} (state-of-the-art report by \citet{Raad2018}) and integrate a modified version of a powerful neural-based texture model by \citet{Gatys2015} into our method
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{\textwidth}
        ...
        \begin{subfigure}{0.3\textwidth}
            ...
            \caption{Desired appearance\footnotemark}
...
\footnotetext{Source: \citet{Pixar128}, modified}
