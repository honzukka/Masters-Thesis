...
{\color{red} TODO: math notation: images and function are confusing. maybe bold for images and call rendering function somethign else than \(x\)?}

{\color{red} TODO: section 2.2 \(\rightarrow\) make references stick together by tilde and capitalize Section! (capitalize also fig. and eq.???)}
