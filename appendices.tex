    ...
    \begin{subfigure}{\textwidth}
        ...
        \begin{subfigure}{0.24\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \fill[black] (-1.05, 1.5) rectangle ++(2.6, 0.6);
                \node [anchor=center] at (0.25, 1.8) {{\color{white} Ours (Gatys)}};
            \end{tikzpicture}
        ...
        \begin{subfigure}{0.24\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \fill[black] (-1.55, 1.5) rectangle ++(3.1, 0.6);
                \node [anchor=center] at (0.0, 1.8) {{\color{white} \small{Ours (Improved)}}};
            \end{tikzpicture}
        ...
        \begin{subfigure}{0.24\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \fill[black] (-1.05, 1.5) rectangle ++(2.6, 0.6);
                \node [anchor=center] at (0.25, 1.8) {{\color{white} Reference}};
            \end{tikzpicture}
    ...
    \begin{subfigure}{\textwidth}
        ...
        \begin{subfigure}{0.24\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \fill[black] (-1.6, -1.2) rectangle ++(2.4, 0.5);
                \node [anchor=center] at (-0.4, -0.95) {{\color{white} \small{Reference}}};
            \end{tikzpicture}
    ...
    \begin{subfigure}{\textwidth}
        ...
        \begin{subfigure}{0.19\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=center] at (-0.3, -0.95) {{\color{white} \small{Reference}}};
            \end{tikzpicture}
