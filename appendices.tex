    ...
    \begin{subfigure}{\textwidth}
        ...
        \begin{subfigure}{0.19\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=center] at (-0.6, -0.95) {{\color{white} \small{Ours}}};
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/04-experiment03/ball/pebbles/stats_proj_highlighted.jpg}
            \caption*{}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.19\textwidth}
        ...
        \begin{subfigure}{0.19\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=center] at (-0.3, -0.95) {{\color{white} \small{Baseline}}};
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/04-experiment03/ball/pebbles/pixel_proj_highlighted.jpg}
            \caption*{}
        \end{subfigure}
        ...
        \begin{subfigure}{0.19\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=center] at (-0.6, -0.95) {{\color{white} \small{Ours}}};
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/04-experiment03/ball/marble/stats_proj_highlighted.jpg}
            \caption*{}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.19\textwidth}
        ...
        \begin{subfigure}{0.19\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=center] at (-0.3, -0.95) {{\color{white} \small{Baseline}}};
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/04-experiment03/ball/marble/pixel_proj_highlighted.jpg}
            \caption*{}
        \end{subfigure}
        ...
        \begin{subfigure}{0.19\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=center] at (-0.6, -0.95) {{\color{white} \small{Ours}}};
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/04-experiment03/ball/wood/stats_proj_highlighted.jpg}
            \caption*{}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.19\textwidth}
        ...
        \begin{subfigure}{0.19\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=center] at (-0.3, -0.95) {{\color{white} \small{Baseline}}};
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/04-experiment03/ball/wood/pixel_proj_highlighted.jpg}
            \caption*{}
        \end{subfigure}
        ...
        \begin{subfigure}{0.19\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=center] at (-0.6, -0.95) {{\color{white} \small{Ours}}};
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/04-experiment03/ball/beams/stats_proj_highlighted.jpg}
            \caption*{\(r(\bm{p})\)}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.19\textwidth}
        ...
        \begin{subfigure}{0.19\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=center] at (-0.3, -0.95) {{\color{white} \small{Baseline}}};
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/04-experiment03/ball/beams/pixel_proj_highlighted.jpg}
            \caption*{\(r(\bm{p})\)}
        \end{subfigure}
    \end{subfigure}
    ...
    \begin{subfigure}{\textwidth}
        ...
        \begin{subfigure}{0.19\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=center] at (-0.6, -0.95) {{\color{white} \small{Ours}}};
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/04-experiment03/ball_dof/pebbles/stats_proj_highlighted.jpg}
            \caption*{}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.19\textwidth}
        ...
        \begin{subfigure}{0.19\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=center] at (-0.3, -0.95) {{\color{white} \small{Baseline}}};
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/04-experiment03/ball_dof/pebbles/pixel_proj_highlighted.jpg}
            \caption*{}
        \end{subfigure}
        ...
        \begin{subfigure}{0.19\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=center] at (-0.6, -0.95) {{\color{white} \small{Ours}}};
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/04-experiment03/ball_dof/marble/stats_proj_highlighted.jpg}
            \caption*{}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.19\textwidth}
        ...
        \begin{subfigure}{0.19\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=center] at (-0.3, -0.95) {{\color{white} \small{Baseline}}};
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/04-experiment03/ball_dof/marble/pixel_proj_highlighted.jpg}
            \caption*{}
        \end{subfigure}
        ...
        \begin{subfigure}{0.19\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=center] at (-0.6, -0.95) {{\color{white} \small{Ours}}};
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/04-experiment03/ball_dof/wood/stats_proj_highlighted.jpg}
            \caption*{}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.19\textwidth}
        ...
        \begin{subfigure}{0.19\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=center] at (-0.3, -0.95) {{\color{white} \small{Baseline}}};
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/04-experiment03/ball_dof/wood/pixel_proj_highlighted.jpg}
            \caption*{}
        \end{subfigure}
        ...
        \begin{subfigure}{0.19\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=center] at (-0.6, -0.95) {{\color{white} \small{Ours}}};
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/04-experiment03/ball_dof/beams/stats_proj_highlighted.jpg}
            \caption*{\(r(\bm{p})\)}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.19\textwidth}
        ...
        \begin{subfigure}{0.19\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=center] at (-0.3, -0.95) {{\color{white} \small{Baseline}}};
            \end{tikzpicture}
            %\includegraphics[width=\textwidth]{images/04-experiment03/ball_dof/beams/pixel_proj_highlighted.jpg}
            \caption*{\(r(\bm{p})\)}
        \end{subfigure}
    \end{subfigure}
    \caption{These results complement section \ref{section:results-experiments-03}. Texture source: \citet{Pixar128}}
